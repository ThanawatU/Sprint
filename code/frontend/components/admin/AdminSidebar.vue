<template>
  <aside
    id="sidebar"
    class="fixed bottom-0 left-0 bg-white shadow-lg sidebar top-16"
  >
    <div class="py-4">
      <!-- Toggle Button -->
      <button
      ...
      <nav class="px-3 space-y-1">
        ...
        >
          <i
            class="w-6 text-lg text-center text-gray-500 fas fa-calendar-check"
          ></i>
        ...
        >
          <i
            class="w-6 text-lg text-center text-gray-500 fas fa-chart-line"
          ></i>
